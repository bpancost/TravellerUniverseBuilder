...
public abstract class TravellerUniverse implements TravellerConstants{
    ...
    protected void generateSizeDescriptorNodes(TransactionalGraph graph){
        ...
        size[0] = manager.createFramedVertex(PlanetSize.class);
        size[0].setWorldSize("800km");
        size[0].setSurfaceGravity("0");

        size[1] = manager.createFramedVertex(PlanetSize.class);
        size[1].setWorldSize("1600km");
        size[1].setSurfaceGravity("0.05");

        size[2] = manager.createFramedVertex(PlanetSize.class);
        size[2].setWorldSize( "3200km");
        size[2].setSurfaceGravity("0.15");

        size[3] = manager.createFramedVertex(PlanetSize.class);
        size[3].setWorldSize("4800km");
        size[3].setSurfaceGravity("0.25");

        size[4] = manager.createFramedVertex(PlanetSize.class);
        size[4].setWorldSize("6400km");
        size[4].setSurfaceGravity("0.35");

        size[5] = manager.createFramedVertex(PlanetSize.class);
        size[5].setWorldSize("8000km");
        size[5].setSurfaceGravity("0.45");

        size[6] = manager.createFramedVertex(PlanetSize.class);
        size[6].setWorldSize("9600km");
        size[6].setSurfaceGravity("0.7");

        size[7] = manager.createFramedVertex(PlanetSize.class);
        size[7].setWorldSize("11200");
        size[7].setSurfaceGravity("0.9");

        size[8] = manager.createFramedVertex(PlanetSize.class);
        size[8].setWorldSize("12800km");
        size[8].setSurfaceGravity("1.0");

        size[9] = manager.createFramedVertex(PlanetSize.class);
        size[9].setWorldSize("14400km");
        size[9].setSurfaceGravity("1.25");

        size[10] = manager.createFramedVertex(PlanetSize.class);
    ...
    protected void generateTemperatureDescriptorNodes(TransactionalGraph graph){
        FramesManager manager = new FramesManager(graph);
        graph.startTransaction();
        temperature[0] = manager.createFramedVertex(PlanetTemperature.class);
        ...
        temperature[3] = manager.createFramedVertex(PlanetTemperature.class);
        ...
        temperature[5] = manager.createFramedVertex(PlanetTemperature.class);
        ...
        temperature[10] = manager.createFramedVertex(PlanetTemperature.class);
        ...
        temperature[12] = manager.createFramedVertex(PlanetTemperature.class);
        temperature[12].setTemperatureType("Hot");
    ...
    protected void generateGovernmentDescriptorNodes(TransactionalGraph graph){
        FramesManager manager = new FramesManager(graph);
        graph.startTransaction();
        government[0] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[1] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[2] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[3] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[4] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[5] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[6] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[7] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[8] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[9] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[10] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[11] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[12] = manager.createFramedVertex(PlanetGovernment.class);
        ...
        government[13] = manager.createFramedVertex(PlanetGovernment.class);
    ...
    protected void generateLawDescriptorNodes(TransactionalGraph graph){
        FramesManager manager = new FramesManager(graph);
        graph.startTransaction();
        law[0] = manager.createFramedVertex(PlanetLaw.class);
        ...
        law[1] = manager.createFramedVertex(PlanetLaw.class);
        ...
        law[2] = manager.createFramedVertex(PlanetLaw.class);
        ...
        law[3] = manager.createFramedVertex(PlanetLaw.class);
        ...
        law[4] = manager.createFramedVertex(PlanetLaw.class);
        ...
        law[5] = manager.createFramedVertex(PlanetLaw.class);
        ...
        law[6] = manager.createFramedVertex(PlanetLaw.class);
        ...
        law[7] = manager.createFramedVertex(PlanetLaw.class);
        ...
        law[8] = manager.createFramedVertex(PlanetLaw.class);
        ...
        law[9] = manager.createFramedVertex(PlanetLaw.class);
    ...
    protected void generateStarportDescriptorNodes(TransactionalGraph graph){
        FramesManager manager = new FramesManager(graph);
        graph.startTransaction();
        starport[0] = manager.createFramedVertex(PlanetStarport.class);
        ...
        starport[3] = manager.createFramedVertex(PlanetStarport.class);
        ...
        starport[5] = manager.createFramedVertex(PlanetStarport.class);
        ...
        starport[7] = manager.createFramedVertex(PlanetStarport.class);
        ...
        starport[9] = manager.createFramedVertex(PlanetStarport.class);
        ...
        starport[11] = manager.createFramedVertex(PlanetStarport.class);
    ...
    protected void generateTechLevelDescriptorNodes(TransactionalGraph graph){
        FramesManager manager = new FramesManager(graph);
        graph.startTransaction();
        techLevel[0] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[1] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[2] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[3] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[4] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[5] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[6] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[7] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[8] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[9] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[10] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[11] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[12] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[13] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[14] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[15] = manager.createFramedVertex(PlanetTechLevel.class);
        ...
        techLevel[16] = manager.createFramedVertex(PlanetTechLevel.class);
        techLevel[16].setDesignation("Unknown");
        techLevel[16].setDescription("Unknown");

        techLevel[17] = manager.createFramedVertex(PlanetTechLevel.class);
        techLevel[17].setDesignation("Unknown");
        techLevel[17].setDescription("Unknown");

        techLevel[18] = manager.createFramedVertex(PlanetTechLevel.class);
        techLevel[18].setDesignation("Unknown");
        techLevel[18].setDescription("Unknown");

        techLevel[19] = manager.createFramedVertex(PlanetTechLevel.class);
